...
**装饰模式**是一种结构型设计模式， 允许你通过将对象放入包含行为的特殊封装对象中来为原对象绑定新的行为。
 ...
 ![装饰设计模式](imgs/02. 什么是装饰器模式？应用场景是什么？/decorator.png)
...
你可以尝试创建一个特殊子类来将多种通知方法组合在一起以解决该问题。 但这种方式会使得代码量迅速膨胀， 不仅仅是程序库代码， 客户端代码也会如此。
 ...
 ![创建组合类后的程序库结构](imgs/02. 什么是装饰器模式？应用场景是什么？/problem3-zh.png)
...
你可以使用这个新方法来轻松替换各种连接的 “小帮手” 对象， 从而能在运行时改变容器的行为。 一个对象可以使用多个类的行为， 包含多个指向其他对象的引用， 并将各种工作委派给引用对象。 聚合 （或组合） 组合是许多设计模式背后的关键原则 （包括装饰在内）。 记住这一点后， 让我们继续关于模式的讨论。
 ...
 ![继承与聚合的对比](imgs/02. 什么是装饰器模式？应用场景是什么？/solution1-zh.png)
...
比如在消息通知示例中， 我们可以将简单邮件通知行为放在基类 `通知器`中， 但将所有其他通知方法放入装饰中。
 ...
 ![装饰模式解决方案](imgs/02. 什么是装饰器模式？应用场景是什么？/solution2-zh.png)

将各种通知方法放入装饰。

客户端代码必须将基础通知器放入一系列自己所需的装饰中。 因此最后的对象将形成一个栈结构。

 ![程序可以配置由通知装饰构成的复杂栈](imgs/02. 什么是装饰器模式？应用场景是什么？/solution3-zh.png)
...
### 真实世界类比
 ...
 ![装饰模式示例](imgs/02. 什么是装饰器模式？应用场景是什么？/decorator-comic-1.png)
...
### 装饰模式结构
 ...
 ![装饰设计模式的结构](imgs/02. 什么是装饰器模式？应用场景是什么？/structure.png)
...
在本例中， **装饰**模式能够对敏感数据进行压缩和加密， 从而将数据从使用数据的代码中独立出来。
 ...
 ![装饰模式示例的结构](imgs/02. 什么是装饰器模式？应用场景是什么？/example.png)

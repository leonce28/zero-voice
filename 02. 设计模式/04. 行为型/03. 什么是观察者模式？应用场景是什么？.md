...
![观察者设计模式](imgs/03. 什么是观察者模式？应用场景是什么？/observer.png)
...
![访问商店或发送垃圾邮件](imgs/03. 什么是观察者模式？应用场景是什么？/observer-comic-1-zh.png)
...
![订阅机制](imgs/03. 什么是观察者模式？应用场景是什么？/solution1-zh.png)
...
![通知方法](imgs/03. 什么是观察者模式？应用场景是什么？/solution2-zh.png)
...
![杂志和报纸订阅](imgs/03. 什么是观察者模式？应用场景是什么？/observer-comic-2-zh.png)
...
![观察者设计模式的结构](imgs/03. 什么是观察者模式？应用场景是什么？/structure.png)
...
![观察者模式示例的结构](imgs/03. 什么是观察者模式？应用场景是什么？/example.png)
